...
import ru.obvilion.box.graphics.g2d.PolygonRegion;
import ru.obvilion.box.graphics.g2d.PolygonRegionLoader;
...
public class AssetManager implements Disposable {
	...
	public AssetManager (FileHandleResolver resolver, boolean defaultLoaders) {
		...
		if (defaultLoaders) {
			...
			setLoader(ru.obvilion.box.graphics.g3d.particles.ParticleEffect.class,
				new ru.obvilion.box.graphics.g3d.particles.ParticleEffectLoader(resolver));
