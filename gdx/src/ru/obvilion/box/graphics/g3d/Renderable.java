 ...
 * {@link ModelBatch#begin(ru.obvilion.box.graphics.Camera)} and {@link ModelBatch#end()}. Therefor Renderable instances cannot
...
public class Renderable {
	 ...
	 * {@link ru.obvilion.box.graphics.VertexAttributes.Usage#BoneWeight} vertex attributes, then the BoneWeight index is used as
