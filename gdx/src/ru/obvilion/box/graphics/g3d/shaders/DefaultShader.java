...
package ru.obvilion.box.graphics.g3d.shaders;
...
import ru.obvilion.box.graphics.g3d.Attributes;
...
import ru.obvilion.box.graphics.g3d.attributes.CubemapAttribute;
import ru.obvilion.box.graphics.g3d.attributes.DepthTestAttribute;
import ru.obvilion.box.graphics.g3d.attributes.DirectionalLightsAttribute;
import ru.obvilion.box.graphics.g3d.attributes.FloatAttribute;
import ru.obvilion.box.graphics.g3d.attributes.IntAttribute;
import ru.obvilion.box.graphics.g3d.attributes.PointLightsAttribute;
import ru.obvilion.box.graphics.g3d.attributes.SpotLightsAttribute;
import ru.obvilion.box.graphics.g3d.attributes.TextureAttribute;
import ru.obvilion.box.graphics.g3d.environment.AmbientCubemap;
...
public class DefaultShader extends BaseShader {
	...
	public static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Box.files.classpath("com/badlogic/gdx/graphics/g3d/shaders/default.vertex.glsl").readString();
	...
	public static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Box.files.classpath("com/badlogic/gdx/graphics/g3d/shaders/default.fragment.glsl").readString();
	...
	public void begin (final Camera camera, final RenderContext context) {
		...
		if (has(u_time)) set(u_time, time += Box.graphics.getDeltaTime());
	}
