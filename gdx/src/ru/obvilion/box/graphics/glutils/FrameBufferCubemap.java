...
public class FrameBufferCubemap extends GLFrameBuffer<Cubemap> {
	 ...
	 * {@link #bindSide(ru.obvilion.box.graphics.Cubemap.CubemapSide)} to activate the side to render onto. */
	@Override
	public void bind () {
		currentSide = -1;
		super.bind();
	...
	protected void bindSide (final Cubemap.CubemapSide side) {
		Box.gl20.glFramebufferTexture2D(GL20.GL_FRAMEBUFFER, GL20.GL_COLOR_ATTACHMENT0, side.glEnum, getColorBufferTexture().getTextureObjectHandle(), 0);
	}
