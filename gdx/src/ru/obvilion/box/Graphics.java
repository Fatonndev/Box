 ...
 * loss. Explore the ru.obvilion.box.graphics package for more classes that might come in handy.
 * @author mzechner */
public interface Graphics {
	...
	/** Create a new cursor represented by the {@link ru.obvilion.box.graphics.Pixmap}. The Pixmap must be in RGBA8888 format,
	 ...
	 *
	 * @param pixmap the mouse cursor image as a {@link ru.obvilion.box.graphics.Pixmap}
	 ...
	 * the image represented by the {@link ru.obvilion.box.graphics.Cursor}. It is recommended to call this function in the main render thread, and maximum one time per frame.
	 *
	 * @param cursor the mouse cursor as a {@link ru.obvilion.box.graphics.Cursor} */
