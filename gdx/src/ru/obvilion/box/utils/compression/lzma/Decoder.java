...
import ru.obvilion.box.utils.compression.lz.OutWindow;
import ru.obvilion.box.utils.compression.rangecoder.BitTreeDecoder;
...
public class Decoder {
	class LenDecoder {
		...
		public void Init () {
			ru.obvilion.box.utils.compression.rangecoder.Decoder.InitBitModels(m_Choice);
		...
		public int Decode (ru.obvilion.box.utils.compression.rangecoder.Decoder rangeDecoder, int posState) throws IOException {
	...
	class LiteralDecoder {
		class Decoder2 {
			...
			public void Init () {
				ru.obvilion.box.utils.compression.rangecoder.Decoder.InitBitModels(m_Decoders);
			}

			public byte DecodeNormal (ru.obvilion.box.utils.compression.rangecoder.Decoder rangeDecoder) throws IOException {
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte (ru.obvilion.box.utils.compression.rangecoder.Decoder rangeDecoder, byte matchByte)
				throws IOException {
				int symbol = 1;
				do {
	...
	ru.obvilion.box.utils.compression.rangecoder.Decoder m_RangeDecoder = new ru.obvilion.box.utils.compression.rangecoder.Decoder();
	...
	void Init () throws IOException {
		...
		ru.obvilion.box.utils.compression.rangecoder.Decoder.InitBitModels(m_IsMatchDecoders);
		ru.obvilion.box.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
		ru.obvilion.box.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepDecoders);
		ru.obvilion.box.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG0Decoders);
		ru.obvilion.box.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG1Decoders);
		ru.obvilion.box.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG2Decoders);
		ru.obvilion.box.utils.compression.rangecoder.Decoder.InitBitModels(m_PosDecoders);
