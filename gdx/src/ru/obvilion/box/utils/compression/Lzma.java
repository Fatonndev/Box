...
package ru.obvilion.box.utils.compression;
...
public class Lzma {
	...
	static public void compress (InputStream in, OutputStream out) throws IOException {
		...
		ru.obvilion.box.utils.compression.lzma.Encoder encoder = new ru.obvilion.box.utils.compression.lzma.Encoder();
	...
	static public void decompress (InputStream in, OutputStream out) throws IOException {
		...
		ru.obvilion.box.utils.compression.lzma.Decoder decoder = new ru.obvilion.box.utils.compression.lzma.Decoder();
