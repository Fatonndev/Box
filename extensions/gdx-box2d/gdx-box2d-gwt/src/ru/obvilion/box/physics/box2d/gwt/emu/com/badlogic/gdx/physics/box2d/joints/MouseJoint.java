...
public class MouseJoint extends Joint {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.MouseJoint joint;
	final Vec2 tmp = new Vec2();

	public MouseJoint (World world, ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.MouseJoint joint) {
		super(world, joint);
		this.joint = joint;
	}
