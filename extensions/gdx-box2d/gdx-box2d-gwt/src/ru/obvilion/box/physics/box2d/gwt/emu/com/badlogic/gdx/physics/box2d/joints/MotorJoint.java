...
public class MotorJoint extends Joint {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.MotorJoint joint;
	
	private final Vector2 linearOffset = new Vector2();
	private final Vec2 tmp = new Vec2();
	
	public MotorJoint (World world, ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.MotorJoint joint) {
		super(world, joint);
		this.joint = joint;
	}
