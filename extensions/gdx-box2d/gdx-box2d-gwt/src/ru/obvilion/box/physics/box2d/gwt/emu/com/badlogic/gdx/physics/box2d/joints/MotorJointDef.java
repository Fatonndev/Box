...
public class MotorJointDef extends JointDef {
	...
	public ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.JointDef toJBox2d () {
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.MotorJointDef jd = new ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.MotorJointDef();
		jd.bodyA = bodyA.body;
		jd.bodyB = bodyB.body;
		...
		jd.type = ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.JointType.MOTOR;
		return jd;
	}
