...
public class WheelJointDef extends JointDef {
	...
	public ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.JointDef toJBox2d () {
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.WheelJointDef fd = new ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.WheelJointDef();
		fd.bodyA = bodyA.body;
		fd.bodyB = bodyB.body;
		...
		fd.type = ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.JointType.WHEEL;
		return fd;
	}
}
