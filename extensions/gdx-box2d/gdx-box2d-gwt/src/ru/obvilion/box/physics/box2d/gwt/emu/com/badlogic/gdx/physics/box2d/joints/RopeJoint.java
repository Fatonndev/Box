...
public class RopeJoint extends Joint {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.RopeJoint joint;

	Vector2 localAnchorA = new Vector2();
	Vector2 localAnchorB = new Vector2();

	public RopeJoint (World world, ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.RopeJoint joint) {
		super(world, joint);
		this.joint = joint;
	}
