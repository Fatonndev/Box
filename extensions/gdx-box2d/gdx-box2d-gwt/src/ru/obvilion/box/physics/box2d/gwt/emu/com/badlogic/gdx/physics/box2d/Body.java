...
public class Body {
	final World world;
	public final ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.Body body;
	...
	protected Body (World world, ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.Body body) {
		this.world = world;
		this.body = body;
	}
	...
	public Transform getTransform () {
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.common.Transform trans = body.getTransform();
	...
	private final ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.MassData massData2 = new ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.MassData();
	...
	public void setType (BodyType type) {
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.BodyType t = ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.BodyType.DYNAMIC;
		if (type == BodyType.DynamicBody) t = ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.BodyType.DYNAMIC;
		if (type == BodyType.KinematicBody) t = ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.BodyType.KINEMATIC;
		if (type == BodyType.StaticBody) t = ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.BodyType.STATIC;
		body.setType(t);
	}

	/** Get the type of this body. */
	public BodyType getType () {
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.BodyType type = body.getType();
		if (type == ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.BodyType.DYNAMIC) return BodyType.DynamicBody;
		if (type == ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.BodyType.KINEMATIC) return BodyType.KinematicBody;
		if (type == ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.BodyType.STATIC) return BodyType.StaticBody;
	...
	public Fixture createFixture (FixtureDef def) {
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.FixtureDef fd = def.toJBox2d();
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.Fixture f = body.createFixture(fd);
	...
	public Fixture createFixture (Shape shape, float density) {
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.Fixture f = body.createFixture(shape.shape, density);
		Fixture fixture = new Fixture(this, f);
		fixtures.add(fixture);
		world.fixtures.put(f, fixture);
		return fixture;
	...
	public Array<JointEdge> getJointList () {
		...
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.JointEdge jointEdge = body.getJointList();
		joints.clear();
