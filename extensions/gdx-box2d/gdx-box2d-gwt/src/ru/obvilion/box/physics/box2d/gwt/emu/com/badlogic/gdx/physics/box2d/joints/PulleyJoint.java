...
public class PulleyJoint extends Joint {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.PulleyJoint joint;

	public PulleyJoint (World world, ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.PulleyJoint joint) {
		super(world, joint);
		this.joint = joint;
	}
