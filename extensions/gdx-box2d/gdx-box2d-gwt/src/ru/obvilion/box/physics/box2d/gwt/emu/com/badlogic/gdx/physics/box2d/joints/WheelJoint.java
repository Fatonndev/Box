...
public class WheelJoint extends Joint {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.WheelJoint joint;

	Vector2 localAnchorA = new Vector2();
	Vector2 localAnchorB = new Vector2();
	Vector2 localAxisA = new Vector2();

	public WheelJoint (World world, ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.WheelJoint joint) {
		super(world, joint);
		this.joint = joint;
	}
