...
public class EdgeShape extends Shape {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.EdgeShape shape;

	public EdgeShape () {
		super(new ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.EdgeShape());
		shape = (ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.EdgeShape)super.shape;
	}

	public EdgeShape (ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.EdgeShape shape) {
		super(shape);
		this.shape = shape;
	}
