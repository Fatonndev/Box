...
import ru.obvilion.box.physics.box2d.gwt.emu.com.badlogic.gdx.physics.box2d.Joint;
import ru.obvilion.box.physics.box2d.gwt.emu.com.badlogic.gdx.physics.box2d.World;
...
public class GearJoint extends Joint {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.GearJoint joint;

	Joint joint1;
	Joint joint2;

	public GearJoint (World world, ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.joints.GearJoint joint, Joint joint1, Joint joint2) {
		super(world, joint);
		this.joint = joint;
		this.joint1 = joint1;
		this.joint2 = joint2;
