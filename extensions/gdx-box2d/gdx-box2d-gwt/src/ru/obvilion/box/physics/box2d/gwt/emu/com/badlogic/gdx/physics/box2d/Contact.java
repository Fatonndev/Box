...
public class Contact {
	final World world;
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.contacts.Contact contact;
	final WorldManifold worldManifold = new WorldManifold();
	final ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.WorldManifold worldManifold2 = new ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.WorldManifold();

	Contact (World world) {
		this.world = world;
	}

	protected Contact (World world, ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.dynamics.contacts.Contact contact) {
		this.world = world;
