...
public class PolygonShape extends Shape {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.PolygonShape shape;

	/** Constructs a new polygon */
	public PolygonShape () {
		super(new ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.PolygonShape());
		shape = (ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.PolygonShape)super.shape;
	}

	public PolygonShape (ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.PolygonShape shape) {
		super(shape);
		this.shape = shape;
	}
