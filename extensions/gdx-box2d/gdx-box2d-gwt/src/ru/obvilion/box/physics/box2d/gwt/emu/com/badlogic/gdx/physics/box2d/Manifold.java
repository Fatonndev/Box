...
public class Manifold {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.Manifold manifold;
	...
	protected Manifold (ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.Manifold manifold) {
		this.manifold = manifold;
	}

	public ManifoldType getType () {
		ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.Manifold.ManifoldType type = manifold.type;
		if (type == ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.Manifold.ManifoldType.CIRCLES) return ManifoldType.Circle;
		if (type == ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.Manifold.ManifoldType.FACE_A) return ManifoldType.FaceA;
		if (type == ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.Manifold.ManifoldType.FACE_B) return ManifoldType.FaceB;
