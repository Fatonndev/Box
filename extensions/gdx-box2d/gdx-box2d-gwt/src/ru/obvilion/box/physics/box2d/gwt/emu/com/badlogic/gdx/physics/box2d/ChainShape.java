...
public class ChainShape extends Shape {
	ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.ChainShape shape;
	boolean isLooped = false;

	public ChainShape () {
		super(new ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.ChainShape());
		shape = (ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.ChainShape)super.shape;
	}

	ChainShape (ru.obvilion.box.physics.box2d.gwt.emu.org.jbox2d.collision.shapes.ChainShape shape) {
		super(shape);
		this.shape = shape;
	}
