...
public class Extras {
	...
	public final static Pool<Vector3> poolVector3 = new Pool<Vector3>() {
		@Override
	...
	public final static Pool<Quaternion> poolQuaternion = new Pool<Quaternion>() {
		@Override
	...
	public final static Pool<Matrix3> poolMatrix3 = new Pool<Matrix3>() {
		@Override
	...
	public final static Pool<Matrix4> poolMatrix4 = new Pool<Matrix4>() {
		@Override
