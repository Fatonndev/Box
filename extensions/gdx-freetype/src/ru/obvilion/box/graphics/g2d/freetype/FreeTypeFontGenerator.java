...
import ru.obvilion.box.graphics.g2d.PixmapPacker;
import ru.obvilion.box.graphics.g2d.PixmapPacker.GuillotineStrategy;
import ru.obvilion.box.graphics.g2d.PixmapPacker.PackStrategy;
import ru.obvilion.box.graphics.g2d.PixmapPacker.SkylineStrategy;
import ru.obvilion.box.graphics.g2d.TextureRegion;
import ru.obvilion.box.graphics.g2d.freetype.FreeType.Bitmap;
import ru.obvilion.box.graphics.g2d.freetype.FreeType.Face;
import ru.obvilion.box.graphics.g2d.freetype.FreeType.GlyphMetrics;
import ru.obvilion.box.graphics.g2d.freetype.FreeType.GlyphSlot;
import ru.obvilion.box.graphics.g2d.freetype.FreeType.Library;
import ru.obvilion.box.graphics.g2d.freetype.FreeType.SizeMetrics;
...
public class FreeTypeFontGenerator implements Disposable {
	...
	Glyph createGlyph (char c, FreeTypeBitmapFontData data, FreeTypeFontParameter parameter, Stroker stroker, float baseLine,
		...
		try {
			...
			mainGlyph.dispose();
			Box.app.log("FreeTypeFontGenerator", "Couldn't render char: " + c);
			return null;
		}
