 ...
 ******************************************************************************/
package ru.obvilion.box.tools.flame;
...
import ru.obvilion.box.graphics.g3d.Environment;
...
import ru.obvilion.box.graphics.g3d.ModelInstance;
import ru.obvilion.box.graphics.g3d.attributes.BlendingAttribute;
import ru.obvilion.box.graphics.g3d.attributes.ColorAttribute;
import ru.obvilion.box.graphics.g3d.environment.DirectionalLight;
...
import ru.obvilion.box.graphics.g3d.particles.ParticleEffectLoader;
import ru.obvilion.box.graphics.g3d.particles.ParticleEffectLoader.ParticleEffectSaveParameter;
import ru.obvilion.box.graphics.g3d.particles.ParticleSystem;
import ru.obvilion.box.graphics.g3d.particles.batches.BillboardParticleBatch;
import ru.obvilion.box.graphics.g3d.particles.batches.ModelInstanceParticleBatch;
import ru.obvilion.box.graphics.g3d.particles.batches.ParticleBatch;
import ru.obvilion.box.graphics.g3d.particles.batches.PointSpriteParticleBatch;
import ru.obvilion.box.graphics.g3d.particles.emitters.Emitter;
import ru.obvilion.box.graphics.g3d.particles.emitters.RegularEmitter;
import ru.obvilion.box.graphics.g3d.particles.influencers.ColorInfluencer;
...
import ru.obvilion.box.graphics.g3d.particles.influencers.ParticleControllerFinalizerInfluencer;
...
import ru.obvilion.box.graphics.g3d.particles.influencers.ScaleInfluencer;
import ru.obvilion.box.graphics.g3d.particles.influencers.SpawnInfluencer;
import ru.obvilion.box.graphics.g3d.particles.renderers.BillboardRenderer;
import ru.obvilion.box.graphics.g3d.particles.renderers.ModelInstanceRenderer;
import ru.obvilion.box.graphics.g3d.particles.renderers.ParticleControllerControllerRenderer;
import ru.obvilion.box.graphics.g3d.particles.renderers.PointSpriteRenderer;
...
import ru.obvilion.box.graphics.g3d.utils.CameraInputController;
import ru.obvilion.box.graphics.g3d.utils.ModelBuilder;
import ru.obvilion.box.math.MathUtils;
import ru.obvilion.box.math.RandomXS128;
import ru.obvilion.box.scene2d.InputEvent;
import ru.obvilion.box.scene2d.Stage;
import ru.obvilion.box.scene2d.ui.Label;
...
public class FlameMain extends JFrame implements AssetErrorListener {
	...
	class AppRenderer implements ApplicationListener {
		...
		public void resize (int width, int height) {
			Box.input.setInputProcessor(new InputMultiplexer(ui, cameraInputController));
		...
		public void render () {
			float delta = Math.max(0, Box.graphics.getDeltaTime() * deltaMultiplier.getValue());
			update(delta);
			renderWorld();
		}
		...
		private void update (float delta) {
			...
			stringBuilder.delete(0, stringBuilder.length);
			stringBuilder.append("FPS : ").append(Box.graphics.getFramesPerSecond());
			fpsLabel.setText(stringBuilder);
			ui.act(Box.graphics.getDeltaTime());
		}

		private void renderWorld () {
			float[] colors = backgroundColor.getColors();
			Box.gl.glClear(GL20.GL_COLOR_BUFFER_BIT | GL20.GL_DEPTH_BUFFER_BIT);
			Box.gl.glClearColor(colors[0], colors[1], colors[2], 0);
