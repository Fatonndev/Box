...
package ru.obvilion.box.tools.hiero.unicodefont;
...
public class GlyphPage {
	...
	private boolean renderGlyph (Glyph glyph, int pageX, int pageY, int width, int height) {
		...
		Box.gl.glTexSubImage2D(texture.glTarget, 0, pageX, pageY, width, height, format, GL11.GL_UNSIGNED_BYTE, glyphPixels);
