		...
		synchronized (input) {
			...
			case MotionEvent.ACTION_HOVER_MOVE:
				...
				if ((x != deltaX) || (y != deltaY)) { // Avoid garbage events
					postTouchEvent(input, DefaultAndroidInput.TouchEvent.TOUCH_MOVED, x, y, 0, timeStamp);
					deltaX = x;
					deltaY = y;
				}
				break;
			...
			case MotionEvent.ACTION_SCROLL:
				...
				postTouchEvent(input, DefaultAndroidInput.TouchEvent.TOUCH_SCROLLED, 0, 0, scrollAmount, timeStamp);
