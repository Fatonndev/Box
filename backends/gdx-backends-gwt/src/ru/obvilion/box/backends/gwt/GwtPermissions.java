		...
		if ("permissions" in $wnd.navigator) {
			$wnd.navigator.permissions.query({
				...
				if (permissionStatus.state === 'granted') {
					result.@ru.obvilion.box.backends.gwt.GwtPermissions.GwtPermissionResult::granted()();
				} else if (permissionStatus.state === 'denied') {
					result.@ru.obvilion.box.backends.gwt.GwtPermissions.GwtPermissionResult::denied()();
				} else if (permissionStatus.state === 'prompt') {
					result.@ru.obvilion.box.backends.gwt.GwtPermissions.GwtPermissionResult::prompt()();
				}
