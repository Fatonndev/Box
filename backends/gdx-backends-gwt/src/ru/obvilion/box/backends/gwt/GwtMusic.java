...
import ru.obvilion.box.backends.gwt.soundmanager2.SMSound;
import ru.obvilion.box.backends.gwt.soundmanager2.SMSound.SMSoundCallback;
import ru.obvilion.box.backends.gwt.soundmanager2.SMSoundOptions;
...
public class GwtMusic implements Music, SMSoundCallback {
	...
	public GwtMusic (FileHandle file) {
		String url = ((GwtApplication) Box.app).getBaseUrl() + file.path();
