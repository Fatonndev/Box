...
package ru.obvilion.box.backends.gwt.soundmanager2;
...
public class SMSound {
	...
	public native final void destruct () /*-{
		this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.destruct();
	}-*/;
	...
	public native final int getPosition () /*-{
		return this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.position;
	}-*/;
	...
	public native final void setPosition (int position) /*-{
		this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.setPosition(position);
	}-*/;
	
	/** Pauses the given sound. (Does not toggle.) Affects paused property (boolean.) */
	public native final void pause () /*-{
		this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.pause();
	}-*/;
	
	/** Starts playing the given sound. */
	public native final void play (SMSoundOptions options) /*-{
		this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.play(
			{
				volume: options.@ru.obvilion.box.backends.gwt.soundmanager2.SMSoundOptions::volume,
				pan: options.@ru.obvilion.box.backends.gwt.soundmanager2.SMSoundOptions::pan,
				loops: options.@ru.obvilion.box.backends.gwt.soundmanager2.SMSoundOptions::loops,
				from: options.@ru.obvilion.box.backends.gwt.soundmanager2.SMSoundOptions::from,
				onfinish: function() {
					var callback = options.@ru.obvilion.box.backends.gwt.soundmanager2.SMSoundOptions::callback;
					if(callback != null) {
						callback.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound.SMSoundCallback::onfinish()();
					}
				}
			}
		);
	...
	public native final void resume () /*-{
		this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.resume();
	}-*/;

	/** Stops playing the given sound. */
	public native final void stop () /*-{
		this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.stop();
	}-*/;
	...
	public native final void setVolume (int volume) /*-{
		this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.setVolume(volume);
	}-*/;

	/** Gets the volume of the give sound.
	 * @return the volume as a value between 0-100. */
	public native final int getVolume () /*-{
		return this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.volume;
	}-*/;
	...
	public native final void setPan (int pan) /*-{
		this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.setPan(pan);
	}-*/;
	
	/** Gets the pan of the give sound.
	 * @return the pan as a value between -100-100. (L/R, 0 = center.)*/
	public native final int getPan () /*-{
		return this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.pan;
	}-*/;
	...
	public native final int getPlayState () /*-{
		return this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.playState;
	}-*/;
	
	/** Boolean indicating pause status. True/False. */
	public native final boolean getPaused () /*-{
		return this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.paused;
	}-*/;
	
	/** Number of times to loop the sound. */
	public native final int getLoops () /*-{
		return this.@ru.obvilion.box.backends.gwt.soundmanager2.SMSound::jsSound.loops;
	}-*/;
}