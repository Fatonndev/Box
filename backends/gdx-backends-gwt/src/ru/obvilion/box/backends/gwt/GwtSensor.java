...
public class GwtSensor extends JavaScriptObject {
	...
	final native void setReadingListener(SensorRead listener) /*-{
		this.onreading = listener.@ru.obvilion.box.backends.gwt.GwtSensor.SensorRead::onReading()();
	}-*/;

	final native void setErrorListener(SensorError listener) /*-{
		this.onerror = listener.@ru.obvilion.box.backends.gwt.GwtSensor.SensorError::onError()();
	}-*/;

	final native void setActivateListener(SensorActivate listener) /*-{
		this.onactivate = listener.@ru.obvilion.box.backends.gwt.GwtSensor.SensorActivate::onActivate()();
	}-*/;
