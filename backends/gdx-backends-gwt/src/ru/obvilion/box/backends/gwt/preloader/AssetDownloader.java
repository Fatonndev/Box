...
package ru.obvilion.box.backends.gwt.preloader;

import ru.obvilion.box.backends.gwt.preloader.AssetFilter.AssetType;
...
public class AssetDownloader {
	...
	static native void hookImgListener (ImageElement img, ImgEventListener h) /*-{
		img
				.addEventListener(
						'load',
						function(e) {
							h.@ru.obvilion.box.backends.gwt.preloader.AssetDownloader.ImgEventListener::onEvent(Lcom/google/gwt/dom/client/NativeEvent;)(e);
						}, false);
		img
				.addEventListener(
						'error',
	...
	private native static void setOnProgress (XMLHttpRequest req, AssetLoaderListener listener) /*-{
		...
		this.onprogress = $entry(function(evt) {
			listener.@ru.obvilion.box.backends.gwt.preloader.AssetDownloader.AssetLoaderListener::onProgress(D)(evt.loaded);
		});
	}-*/;
